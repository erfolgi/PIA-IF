 ...
 */
public class DokumenFragment extends Fragment implements BeritaView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((DashActivity) getActivity()).setActionBarTitle("Dokumen");
        view = inflater.inflate(R.layout.fragment_dokumen, container, false);
        RV = (RecyclerView)view.findViewById(R.id.rv_dokumen);
        beritaPresenter=new BeritaPresenter();

        SW=view.findViewById(R.id.sw_dokumen);
    ...
    public void loadBerita(){
        ...
        Call<KategoriModel> apiCall = apiClient.getService().getDataByKategori("Dokumen");
