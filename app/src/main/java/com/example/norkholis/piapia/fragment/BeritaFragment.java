...
public class BeritaFragment extends Fragment implements BeritaView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((DashActivity) getActivity()).setActionBarTitle("Berita");
        ...
        SW=view.findViewById(R.id.sw_berita);
    ...
    public void loadBerita(final View view){
        apiClient= new APIClient();
        Call<KategoriModel> apiCall = apiClient.getService().getDataByKategori("Berita");
